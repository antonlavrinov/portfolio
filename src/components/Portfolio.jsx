...
const Portfolio = () => {
  const data = useStaticQuery(graphql`
    query portfolioPieces {
      ...
      socialMedia: file(relativePath: { eq: "social.jpg" }) {
        childImageSharp {
          fluid(maxWidth: 500, quality: 100) {
            ...GatsbyImageSharpFluid_withWebp
          }
  ...
  const socialMediaPreview = data.socialMedia.childImageSharp.fluid
  return (
    <>
      <PortfolioSection>
        <Container>
          <PortfolioSectionWrapper>
            ...
            <PortfolioWrapper>
              <a
                href="https://antonlavrinov.github.io/Memory-Game/"
                rel="noopener noreferrer"
                target="_blank"
              >
                <PortfolioItemWrapper
                  style={{ backgroundSize: "cover" }}
                  fluid={memoryGamePreview}
                >
                  <LinkOut />
                </PortfolioItemWrapper>
              </a>
              ...
              >
                <PortfolioItemWrapper
                  style={{ backgroundSize: "cover" }}
                  fluid={granichPreview}
                >
                  <LinkOut />
                </PortfolioItemWrapper>
              </a>
              <a
                href="https://social-media-intouch.herokuapp.com/"
                rel="noopener noreferrer"
                target="_blank"
              >
                <PortfolioItemWrapper
                  style={{
                    ...
                    border: "2px solid #8b97b2",
                  }}
                  fluid={socialMediaPreview}
                >
                  <LinkOut />
                </PortfolioItemWrapper>
              </a>
              <a
                href="https://thirsty-lichterman-7f4fc4.netlify.app/"
                rel="noopener noreferrer"
                target="_blank"
              >
                <PortfolioItemWrapper
                  style={{ backgroundSize: "cover" }}
                  fluid={gentlemanPreview}
                >
                  <LinkOut />
                </PortfolioItemWrapper>
              </a>
              <a
                href="https://antonlavrinov.github.io/bookstore/"
                rel="noopener noreferrer"
                target="_blank"
              >
                <PortfolioItemWrapper
                  style={{ backgroundSize: "cover" }}
                  fluid={bookstorePreview}
                >
                  <LinkOut />
                </PortfolioItemWrapper>
              </a>
